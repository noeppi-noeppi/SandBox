...
public class DimensionTypeData extends SingleWorldGenData<DimensionType> {

    public DimensionTypeData(Properties properties) {
        super(properties, Registry.DIMENSION_TYPE_REGISTRY, DimensionType.DIRECT_CODEC);
    }
    ...
    public class DimensionTypeBuilder {
        ...
        public Holder<DimensionType> build() {
            ...
            return DimensionTypeData.this.addToList(DimensionTypeData.this.registries.holder(Registry.DIMENSION_TYPE_REGISTRY, type));
        }
    }
}
