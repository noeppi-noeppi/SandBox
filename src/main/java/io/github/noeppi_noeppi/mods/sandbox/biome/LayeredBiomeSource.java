...
public class LayeredBiomeSource extends BiomeSource {
    ...
    public static final Codec<LayeredBiomeSource> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            RegistryCodecs.homogeneousList(SandBox.BIOME_LAYER_REGISTRY, BiomeLayer.DIRECT_CODEC).fieldOf("layers").forGetter((LayeredBiomeSource biomes) -> biomes.layers)
    ...
    public void init(long seed) {
        ...
        this.sources = layersInOrder.stream().map(layer -> new MultiNoiseBiomeSource(layer.biomes())).toArray(MultiNoiseBiomeSource[]::new);
    }
